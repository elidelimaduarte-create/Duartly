...
const { handleCallbackCartao, handleTextoCartao, iniciarFluxoCartao, handleCadastrarCartao } = require('./handlers/cartaoHandler');
...
bot.command('cartao',    handleCadastrarCartao);
